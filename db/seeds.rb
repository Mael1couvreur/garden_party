...
plant1 =Plant.create!(nickname: "Boby", like_number: 0, user: user1, plant_information: PlantInformation.find_by(name: "Cocotier"), age_in_days: 114)
...
plant2 = Plant.create!(nickname: "Zeubi", like_number: 0, user: user1, plant_information: PlantInformation.find_by(name: "Monstera"), age_in_days: 66)
...
plant3 = Plant.create!(nickname: "Mimi", like_number: 0, user: user2, plant_information: PlantInformation.find_by(name: "Cactus"), age_in_days: 69)
...
plant5 = Plant.create!(nickname: "Loulou", like_number: 0, user: user2, plant_information: PlantInformation.find_by(name: "Cactus"), age_in_days: 33)
