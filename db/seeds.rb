...
puts user1.class
plant1 =Plant.create!(nickname: "Boby", like_number: 0, user: User.find(1), plant_information: PlantInformation.find_by(name: "Cocotier"), age_in_days: 114, like_number: rand(1..50))
...
plant2 = Plant.create!(nickname: "Zeubi", like_number: 0, user: User.find(1), plant_information: PlantInformation.find_by(name: "Monstera"), age_in_days: 66, like_number: rand(1..50))
...
plant3 = Plant.create!(nickname: "Mimi", like_number: 0, user: User.find(2), plant_information: PlantInformation.find_by(name: "Cactus"), age_in_days: 69, like_number: rand(1..50))
...
plant4 = Plant.create!(nickname: "Fifi", like_number: 0, user: User.find(2), plant_information: PlantInformation.find_by(name: "Tulipe"), age_in_days: 76, like_number: rand(1..50))
...
plant5 = Plant.create!(nickname: "Loulou", like_number: 0, user: User.find(2), plant_information: PlantInformation.find_by(name: "Cactus"), age_in_days: 33, like_number: rand(1..50))
...
plant7 = Plant.create!(nickname: "Salamèche", like_number: 0, user: User.find(3), plant_information: PlantInformation.find_by(name: "Tulipe"), age_in_days: 484, like_number: rand(1..50))
...
plant8 = Plant.create!(nickname: "Bulbizarre", like_number: 0, user: User.find(3), plant_information: PlantInformation.find_by(name: "Monstera"), age_in_days: 69, like_number: rand(1..50))
...
plant9 = Plant.create!(nickname: "Carapuce", like_number: 0, user: User.find(3), plant_information: PlantInformation.find_by(name: "Strawberry"), age_in_days: 19, like_number: rand(1..50))
