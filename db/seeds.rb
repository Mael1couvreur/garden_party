...
plant2 = Plant.create!(nickname: "Alfred", user: User.find_by(first_name: "Vio"), plant_information: PlantInformation.find_by(name: "Monstera"), age_in_days: 66, like_number: rand(1..50))
...
plant4 = Plant.create!(nickname: "Tony", user: User.find_by(first_name: "Mael"), plant_information: PlantInformation.find_by(name: "Tulipe"), age_in_days: 76, like_number: rand(1..50))
...
plant7 = Plant.create!(nickname: "Tom", user: User.find_by(first_name: "Hugo"), plant_information: PlantInformation.find_by(name: "Tulipe"), age_in_days: 484, like_number: rand(1..50))
...
plant9 = Plant.create!(nickname: "Capitaine", user: User.find_by(first_name: "Hugo"), plant_information: PlantInformation.find_by(name: "Strawberry"), age_in_days: 19, like_number: rand(1..50))
