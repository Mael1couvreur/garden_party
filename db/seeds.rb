...
plant1 =Plant.create!(nickname: "Boby", user: User.find_by(first_name: "Vio"), plant_information: PlantInformation.find_by(name: "Cocotier"), age_in_days: 114, like_number: rand(1..50))
...
plant2 = Plant.create!(nickname: "Zeubi", user: User.find_by(first_name: "Vio"), plant_information: PlantInformation.find_by(name: "Monstera"), age_in_days: 66, like_number: rand(1..50))
...
plant3 = Plant.create!(nickname: "Mimi", user: User.find_by(first_name: "Mael"), plant_information: PlantInformation.find_by(name: "Cactus"), age_in_days: 69, like_number: rand(1..50))
...
plant4 = Plant.create!(nickname: "Fifi", user: User.find_by(first_name: "Mael"), plant_information: PlantInformation.find_by(name: "Tulipe"), age_in_days: 76, like_number: rand(1..50))
...
plant5 = Plant.create!(nickname: "Loulou", user: User.find_by(first_name: "Mael"), plant_information: PlantInformation.find_by(name: "Cactus"), age_in_days: 33, like_number: rand(1..50))
...
plant7 = Plant.create!(nickname: "Salamèche", user: User.find_by(first_name: "Hugo"), plant_information: PlantInformation.find_by(name: "Tulipe"), age_in_days: 484, like_number: rand(1..50))
...
plant8 = Plant.create!(nickname: "Bulbizarre", user: User.find_by(first_name: "Hugo"), plant_information: PlantInformation.find_by(name: "Monstera"), age_in_days: 69, like_number: rand(1..50))
...
plant9 = Plant.create!(nickname: "Carapuce", user: User.find_by(first_name: "Hugo"), plant_information: PlantInformation.find_by(name: "Strawberry"), age_in_days: 19, like_number: rand(1..50))
